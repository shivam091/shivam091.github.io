...
export default function Hero(): JSX.Element {
  ...
  return (
    ...
    >
      <div className="flex flex-col items-start justify-center gap-3 w-full max-w-4xl">
        <h1 className={`${styles.heroHeading} text-4xl sm:text-5xl md:text-6xl font-semibold tracking-tight leading-tight`}>
          <span className="text-(--color-fg-muted) block mb-2 lowercase first-letter:uppercase">
            {timeGreeting}
          </span>
