...
import styles from "@/components/SiteHeader/SiteName/SiteName.module.scss";

// Renders the site wordmark as an inline SVG — first name, a hand-drawn initial separator, and last name.
