...
import styles from "@/components/SkyBanners/SkyBannerBottom/SkyBannerBottom.module.scss";

export default function SkyBannerBottom(): JSX.Element {
  return (
    <>
      <div className={styles.skyBannerBottom} aria-hidden="true">
        {/* Overlay cloud that sits on top of the bottom layer — right-anchored */}
        <svg
          width="1590"
          height="213"
          ...
          className={styles.cloudLayersTopOverlay}
          focusable={false}
        >
          <path
            ...
            className={styles.bottomCloudOverlay}
          />
        </svg>

        {/* Wide panoramic cloud row that fills the bottom */}
        <div className={styles.cloudLayersBottom} role="presentation">
          <svg
            width="5120"
            height="337"
            ...
            preserveAspectRatio="none"
            xmlns="http://www.w3.org/2000/svg"
            className={styles.cloudShapesBottom}
            focusable={false}
          >
            <path
              ...
              className={styles.bottomBackgroundClouds}
            />
          </svg>
        </div>
      </div>
